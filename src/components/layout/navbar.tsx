      ...
      <div className="container mx-auto flex h-24 items-center justify-between gap-x-8 px-4 sm:px-6 lg:px-4 xl:px-8">
        ...
        <div className="hidden lg:flex lg:items-center lg:gap-3 xl:gap-6 2xl:gap-10">
          ...
          <div className="hidden xl:flex items-center gap-3 ml-2">
            ...
            <a href="https://www.tiktok.com/@ackstpaulsparishsouthc" target="_blank" rel="noopener noreferrer" className="text-[#000000] hover:opacity-80 transition-opacity" aria-label="TikTok">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="18" height="18" fill="currentColor">
                <path d="M448,209.91a210.06,210.06,0,0,1-122.77-39.25V349.38A162.55,162.55,0,1,1,185,188.31V278.2a74.62,74.62,0,1,0,52.23,71.18V0l88,0a121.18,121.18,0,0,0,1.86,22.17h0A122.18,122.18,0,0,0,381,102.39a121.43,121.43,0,0,0,67,20.14Z"/>
              </svg>
            </a>
            <a href="https://web.facebook.com/Ackstpaulssouthc" target="_blank" rel="noopener noreferrer" className="text-[#1877F2] hover:opacity-80 transition-opacity" aria-label="Facebook">
            ...
            <a href="https://www.youtube.com/@ackstpaulsparishsouthc" target="_blank" rel="noopener noreferrer" className="text-[#FF0000] hover:opacity-80 transition-opacity" aria-label="YouTube">
