...
export default function MenMinistryPage() {
  ...
  const heroSlides = [
    ...
    {
      image: "/images/kamamen.jpeg",
      badge: "Family Values",
      title: <>Pillars of <span className="text-secondary">Strong Families</span></>,
      desc: "Supporting men as leaders in their homes through Christian family values, economic empowerment, and continuous learning.",
    },
  ];
